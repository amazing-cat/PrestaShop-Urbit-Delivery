...
class UbitAPIWrapper
{
    ...
    public function send()
    {
        ...
        $version = Module::getInstanceByName('urbit')->version;
        curl_setopt($ch, CURLOPT_USERAGENT, "Module-PrestaShop1.6-Urbit-Delivery/version-$version/Prestashop/version/" . _PS_VERSION_);
